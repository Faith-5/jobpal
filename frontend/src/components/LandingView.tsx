...
export const LandingView: React.FC<LandingViewProps> = ({ onNavigate }) => {
  return (
    <div
      id="landing-page"
      className="min-h-screen flex flex-col bg-[#0B0F19] text-[#E2E8F0] font-body selection:bg-blue-600/35 selection:text-white"
    >
      {/* Top Navigation */}
      <header
        id="landing-header"
      ...
      >
        <div className="flex justify-between items-center px-6 py-4 max-w-[1280px] mx-auto">
          ...
          <nav
            ...
            className="hidden md:flex items-center gap-8 font-body text-[15px] font-medium"
          >
            <a
              href="#preview"
      ...
      <main className="flex-grow flex flex-col relative overflow-hidden">
        ...
        >
          ...
          <p className="font-body text-[17px] sm:text-[19px] text-[#94A3B8] max-w-2xl mb-10 leading-relaxed">
            One master profile. Infinite tailored variants. Optimize your
            achievements with hard metrics, auto-integrate critical keywords,
            and apply with confidence in under 60 seconds.
          </p>
        ...
        <section
          id="preview"
          className="px-6 pb-20 relative max-w-[1000px] mx-auto w-full"
        >
          <div className="relative rounded-2xl bg-[#0F172A]/50 border border-[#1E293B]/70 p-6 sm:p-8 backdrop-blur-md shadow-2xl flex flex-col md:flex-row gap-8 items-stretch group hover:border-blue-500/30 transition-all duration-500">
            ...
            <div className="flex-1 bg-[#0B0F19]/90 rounded-xl p-6 border border-[#1E293B] flex flex-col justify-between relative z-10">
              <div>
                ...
                <h4 className="text-[17px] font-bold text-white mb-4">
                ...
                <div className="flex items-center gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] text-slate-400 mt-0.5 leading-tight">
                      Your CV matches all primary keywords and formatting rules.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-[#1E293B] pt-4 flex gap-4 text-[13px]">
                <div className="flex-1">
                  ...
                  <span className="text-white font-bold font-headline text-[15px]">
                    97%
                  </span>
                </div>
            ...
            <div className="flex-1 flex flex-col justify-between relative z-10">
              <div>
                <span className="text-[11px] text-[#38BDF8] font-bold uppercase tracking-wider block mb-2">
                  Smart Recommendations
                </span>
                <p className="text-[#94A3B8] text-[13px] mb-4 leading-relaxed">
                  JobPal automatically finds gaps in your CV and helps you fix
                  them instantly.
                </p>
                ...
                <div className="space-y-3">
                  <div className="bg-[#0B0F19]/40 border border-[#1E293B]/80 rounded-xl p-3.5 flex items-start gap-3 hover:border-blue-500/30 transition-colors">
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-[11px] text-slate-400 mt-1">
                        Change "Improved user retention" to "Improved user
                        retention by 24% over 6 months."
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#0B0F19]/40 border border-blue-500/30 rounded-xl p-3.5 flex items-start gap-3">
                    ...
                    <div className="flex-grow">
                      <h5 className="text-[13px] font-bold text-slate-300">
                        Added keyword: "Prototyping"
                      </h5>
                      <p className="text-[11px] text-slate-500 mt-1">
                        Found 4 times in the job description; added to your
                        skills list.
                      </p>
                    </div>
                  </div>
        ...
        <section
          id="workspace"
          className="py-20 px-6 max-w-[1280px] mx-auto w-full border-t border-[#1E293B]/60"
        >
          <div className="text-center mb-16">
            ...
            <p className="font-body text-[16px] sm:text-[18px] text-[#94A3B8] max-w-xl mx-auto">
              Simple tools that take the stress out of applying for jobs,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-[#0F172A]/40 border border-[#1E293B]/50 rounded-2xl p-8 flex items-start gap-5 hover:border-[#1E293B]/80 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-sm text-[#94A3B8] leading-relaxed">
                  Keep all your applications in one clean dashboard. Move cards
                  from "Applied" to "Interviewing" and "Offers" as you progress,
                  keeping your search simple and organized.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#0F172A]/40 border border-[#1E293B]/50 rounded-2xl p-8 flex items-start gap-5 hover:border-[#1E293B]/80 transition-all duration-300">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">
                  Paste & Tailor Instantly
                </h3>
                <p className="text-sm text-[#94A3B8] leading-relaxed">
                  Just copy-paste any job description. JobPal automatically
                  updates your skills list and experience text bullets to align
                  perfectly with the target role.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#0F172A]/40 border border-[#1E293B]/50 rounded-2xl p-8 flex items-start gap-5 hover:border-[#1E293B]/80 transition-all duration-300">
              ...
              <div>
                ...
                <p className="text-sm text-[#94A3B8] leading-relaxed">
                  JobPal updates as you grow. Every resume change you accept
                  automatically updates your master profile, keeping you ready
            ...
            <div className="bg-[#0F172A]/40 border border-[#1E293B]/50 rounded-2xl p-8 flex items-start gap-5 hover:border-[#1E293B]/80 transition-all duration-300">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">
                  Safe Qualifications Vault
                </h3>
                <p className="text-sm text-[#94A3B8] leading-relaxed">
                  More than just job hunting. Safely store your complete history
                  of credentials, projects, and skills in one secure vault.
                  Ready to export for contracts, speaking gigs, or promotions
                  anytime.
                </p>
              </div>
            </div>
        ...
        <section
          id="capabilities"
          className="py-24 px-6 border-t border-[#1E293B]/60 bg-[#0F172A]/10 w-full"
        >
          <div className="max-w-[1280px] mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="font-body text-[16px] sm:text-[18px] text-[#94A3B8] max-w-2xl mx-auto">
                No complex layouts or settings. Just high-impact features that
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-[#0F172A]/50 border border-[#1E293B]/40 p-8 rounded-2xl shadow-sm hover:border-[#1E293B]/80 transition-all flex flex-col items-start">
                ...
                <p className="font-body text-[14px] text-[#94A3B8] leading-relaxed">
                  Our clean, structured layouts pass through automated screening
                  filters (Taleo, Greenhouse, Workday) with ease, so human
                  recruiters actually see your CV.
                </p>
              </div>
              ...
              <div className="bg-[#0F172A]/50 border border-[#1E293B]/40 p-8 rounded-2xl shadow-sm hover:border-[#1E293B]/80 transition-all flex flex-col items-start">
                ...
                <p className="font-body text-[14px] text-[#94A3B8] leading-relaxed">
                  JobPal automatically finds which required skills are missing
                  from your resume and suggests exactly where to add them to
                  boost compatibility.
                </p>
              </div>
              ...
              <div className="bg-[#0F172A]/50 border border-[#1E293B]/40 p-8 rounded-2xl shadow-sm hover:border-[#1E293B]/80 transition-all flex flex-col items-start">
                ...
                <p className="font-body text-[14px] text-[#94A3B8] leading-relaxed">
                  AI scans your descriptions, replacing weak phrases with
                  concrete metrics and numbers, immediately highlighting your
                  actual impact.
                </p>
              </div>
            </div>
        ...
        <section className="py-24 px-6 border-t border-[#1E293B]/60 text-center relative overflow-hidden bg-gradient-to-b from-transparent to-[#0F172A]/30">
          <div className="max-w-[700px] mx-auto z-10 relative">
            <h2 className="font-headline text-[32px] sm:text-[40px] font-bold text-white mb-4">
              Ready to simplify your applications?
            </h2>
            <p className="text-[#94A3B8] text-[16px] sm:text-[18px] mb-8 leading-relaxed">
              Join thousands of candidates who stopped manually formatting their
              resumes and started landing interviews.
            </p>
            <button
              onClick={() => onNavigate("signup")}
